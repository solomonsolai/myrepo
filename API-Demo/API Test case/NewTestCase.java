...
public class NewTestCase {
	...
	private static final Logger lOGGER = LoggerFactory.getLogger(NewTestCase.class);
	private enum Status {
		PASS, FAIL
	}
	...
	public void testCase() throws Exception {
		try {
			...
			// Web Service Request
		launchService("{\"operationName\":\"POST\",\"requestType\":\"application/json\",\"endPointUrl\":\"http://localhost:8010/sh/getSessionId\",\"authorization\":{\"accessToken\":\"\",\"authorizationType\":\"None\",\"certificateUrl\":\"\",\"consumerKey\":\"\",\"consumerSecret\":\"\",\"password\":\"\",\"secretToken\":\"\",\"userName\":\"\"},\"assertions\":[],\"body\":{\"username\":\"John\",\"password\":\"test\"},\"headers\":[{\"isHeaderRequired\":false,\"headerValue\":\"\",\"headerKey\":\"\"}]}");
			// Web Service Request
