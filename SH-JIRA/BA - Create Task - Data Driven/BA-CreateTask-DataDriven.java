...
public class BA-CreateTask-DataDriven {
	private static ExtentReports extentReports;
	private static ExtentTest test;
	private static final Logger lOGGER = LoggerFactory.getLogger(BA-CreateTask-DataDriven.class);
	private enum Status {
		PASS, FAIL
	}
 ...
 public void keyPress(WebDriver webDriver, String objectType, String objectValue, String data) {
	...
	public void testCase()  throws Exception {
		...
		try {
			...
			// Given open website "http://shusncdjira01.ivhinc.net:8080/login.jsp"
			webDriver = launch("http://shusncdjira01.ivhinc.net:8080/login.jsp");
			// When user enter username as "uatmntl"
			keyIn(webDriver, "xpath", "//*[@id=\"login-form-username\"]", "uatmnba");
			// And user enter password as "uatmntl"
			keyIn(webDriver, "xpath", "//*[@id=\"login-form-password\"]", "uatmnba");
			// And click on log in button
			click(webDriver, "xpath", "//*[@id=\"login-form-submit\"]");
			// When user Navigates to Projects and Click on Projects
			click(webDriver, "xpath", "//*[@id=\"browse_link\"]");
			// And click on Test Project2
			click(webDriver, "xpath", "//*[@id=\"footer-report-problem-link\"]");
			// And click on Create button
			click(webDriver, "xpath", "//*[@id=\"create_link\"]");
			// And Click on Issue Type
			click(webDriver, "xpath", "//*[@id=\"issuetype-field\"]");
			// And Enter
			keyIn(webDriver, "xpath", "//*[@id=\"issuetype-field\"]", "Keys.CLEAR");
			// And Wait for "5" seconds
			waitFor(webDriver, "5");
			// And Enter Issue Type
			keyIn(webDriver, "xpath", "//*[@id=\"issuetype-field\"]", "Task");
			// And Click on Summary
			click(webDriver, "xpath", "//input[@id=\"summary\"]");
			// And Enter Summary as
			keyIn(webDriver, "xpath", "//input[@id=\"summary\"]", "SH-TASK1");
		} finally {
			quit(webDriver);
		}
	}
